...
@php
    $initialPasswordResetStep = $errors->any() ? 'password' : 'email';
@endphp
...
@section('content')
    ...
    <form
        ...
        data-initial-step="{{ $initialPasswordResetStep }}"
        ...
        <section class="register-step" data-password-reset-step="email">
            ...
            <div class="auth-field">
                ...
                <div @class(['auth-input-wrap', 'has-error' => $errors->has('email')])>
                    ...
                    <input id="reset_email" type="email" name="email" value="{{ old('email') }}" placeholder="Nhập email của bạn" required autocomplete="username">
                </div>
        ...
        <section class="register-step" data-password-reset-step="password" hidden>
            <div class="register-email-summary">
                ...
                <div>
                    ...
                    <strong data-password-reset-email-value>{{ old('email') }}</strong>
                </div>
            ...
            <div class="auth-field">
                ...
                <div @class(['auth-input-wrap', 'has-error' => $errors->has('password_confirmation')])>
                    <x-auth.sharedKT.icon name="lock" class="auth-input-icon" />
                    <input id="password_confirmation" type="password" name="password_confirmation" placeholder="Nhập lại mật khẩu mới" required autocomplete="new-password">
