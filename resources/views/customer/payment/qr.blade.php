                ...
                <div class="p-6 sm:p-10 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                    ...
                    <div class="md:col-span-5 flex flex-col items-center justify-center p-6 bg-[#FAF6EE] rounded-3xl border border-[#EBDDCD] text-center">
                        ...
                        <div class="mt-4 text-xs text-[#786B61] leading-relaxed">
                            ...
                            @elseif($order->payment_method === 'E_WALLET')
                                Mở ứng dụng <strong>Ví MoMo</strong> trên điện thoại để quét mã chuyển tiền nhanh 24/7.
                            @else
                        ...
                        <div class="space-y-3 bg-[#FDFBF7] p-5 rounded-2xl border border-[#EBDDCD]">
                            ...
                            @if($order->payment_method === 'E_WALLET')
                                ...
                                <div class="pt-2 space-y-2">
                                    ...
                                    <a href="https://me.momo.vn/{{ preg_replace('/[^0-9]/', '', $paymentConfig['momo_phone']) }}" target="_blank"
                                       class="w-full bg-[#FFF0F5] hover:bg-[#FFE4EE] text-[#A50064] border border-[#FAD2E1] font-bold py-2 px-3 rounded-xl text-xs flex items-center justify-center gap-1.5 transition">
                                        ...
                                        <span>Trang chuyển tiền MoMo Me (me.momo.vn/{{ $paymentConfig['momo_phone'] }})</span>
                                    </a>
                                </div>
                            @elseif($order->payment_method === 'CARD')
